{
    ...
    var program = createProgramFromShaders(vss, fss);
    // static
    ...
    var transformData_1 = new Float32Array([
    ...
    var transformBuffer_1 = gl.createBuffer();
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, transformBuffer_1);
    gl.bufferData(gl.ARRAY_BUFFER, transformData_1, gl.DYNAMIC_DRAW);
    var F = false;
    ...
    function draw() {
        ...
        transformData_1[0] = 0;
        transformData_1[1] = 0;
        transformData_1[13] = .5;
        transformData_1[14] = -.5;
        gl.bindBuffer(gl.ARRAY_BUFFER, transformBuffer_1);
        gl.bufferData(gl.ARRAY_BUFFER, transformData_1, gl.DYNAMIC_DRAW);
        gl.drawArraysInstanced(gl.TRIANGLES, 0, 6, 1);
    }
